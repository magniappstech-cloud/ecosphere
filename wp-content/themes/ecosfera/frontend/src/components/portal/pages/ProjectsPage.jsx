function getStatusPresentation(status) {
  ...
  if (['finish', 'done', 'completed', 'finished', 'завершен', 'завершён'].includes(normalized)) {
    return { className: 'status-done' };
  }

  if (['process', 'active', 'in-progress', 'in_progress', 'progress', 'активен', 'в работе', 'в процессе'].includes(normalized)) {
    return { className: 'status-active' };
  }
    ...
    : [
      {
        ...
        },
        {
          ...
          excerpt: 'Пилоты по безопасной энергетической инфраструктуре.',
          featuredImage: '',
          status: 'finish',
        ...
        {
          id: 3,
          title: 'Открытая лаборатория',
          excerpt: 'Образовательные программы и полевые исследования.',
          featuredImage: '',
          status: 'process',
          statusLabel: 'В работе',
          format: 'initiative',
  ...
  return (
    <div className="page-inner-pad">
      <section
        className="sec"
        style={{
          background: 'radial-gradient(ellipse 60% 45% at 50% 0%,rgba(42,245,152,.04),transparent 60%)',
        }}
      >
        <div className="container">
          ...
          <h1
            ...
            style={{ fontSize: 'clamp(32px,5vw,56px)', marginBottom: 'var(--sp-3)' }}
          >
            Проекты платформы
          </h1>
          <p className="sec-sub reveal">
            Реальные инициативы реальных людей. Нажмите на карточку для деталей.
          </p>
                ...
                <article key={project.id} className="project-card">
                  ...
                  <div className="project-body">
                    ...
                    <p className="project-desc">
                      {project.excerpt || 'Описание проекта будет заполняться из WordPress.'}
                    </p>
